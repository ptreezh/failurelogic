...
async def run_navigation_interaction_test():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # Find and click the scenarios navigation button
                ...
                if all_cards:
                    ...
                    for elem in all_grid_elements:
                        try:
                            ...
                            if tag_name in ['button', 'a'] or 'button' in (await elem.get_attribute('class') or '') or 'click' in (await elem.get_attribute('class') or ''):
            ...
            if await exponential_nav_button.count() > 0:
                try:
                    ...
                    is_exponential_active = await page.locator("#exponential-page.active").count() > 0
                    if is_exponential_active:
                        print("✅ 成功导航到指数测试页面")
